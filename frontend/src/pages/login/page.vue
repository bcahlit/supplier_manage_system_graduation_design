            ...
            .then(() => {
              UserInfo({})
                .then(res => {
                  ...
                  if(res.user.role === 'admin') admin = baseAside.concat(admin)
                  if(res.user.role === 'pusher') admin = baseAside.concat(pusher)
                  if(res.user.role === 'ratify') admin = baseAside.concat(ratify)
                  if(res.user.role === 'statistic') admin = baseAside.concat(statistic)
                  if(res.user.role === 'pushin') admin = baseAside.concat(pushin)
                  if(res.user.role === 'warehouse') admin = baseAside.concat(warehouse)
